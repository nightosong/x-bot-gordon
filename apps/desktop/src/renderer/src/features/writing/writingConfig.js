...
export const WRITING_STORY_ENGINE_OPTIONS = [
  ...
  { value: "成长升级", label: "成长升级" },
  { value: "生存压力", label: "生存压力" }
];

export const WRITING_GENRE_PROMPT_GUIDES = {
  探险: {
    engine: "地图探索 / 生存压力 / 成长升级",
    guide:
      "题材驱动：优先让地图、生态、地方活法和风险探索推动章节；新区域必须改变路线、资源、关系或主角能力边界，不要滑向纯真相揭露或任务链。"
  },
  都市: {
  ...
  武侠: {
    ...
    guide:
      "题材驱动：优先写江湖规矩、师承债务、门派脸面、身体技艺和义利冲突；武力变化要由训练、伤势、兵器、地形和名声代价支撑。"
  },
  现实: {
