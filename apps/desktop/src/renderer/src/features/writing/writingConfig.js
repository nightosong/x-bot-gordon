...
export const WRITING_LENGTH_PROFILES = {
  ...
  long: {
    label: "长篇",
    scope: "持续扩展的成长长线",
    method: "先确定主角的长期行动方向、阶段权限、资源压力、能力边界和可持续扩展的卷级区域，再补时代、制度、利益网络、技艺铺垫链与伏笔回收；开篇仍优先聚焦主角，不用群像开局。"
  }
};

export const WRITING_GENRE_PROFILE_OPTIONS = [
  { value: "探险", label: "探险" },
  { value: "都市", label: "都市" },
  { value: "言情", label: "言情" },
  { value: "悬疑", label: "悬疑" },
...
export const WRITING_STORY_ENGINE_OPTIONS = [
  { value: "地图探索", label: "地图探索" },
  { value: "关系博弈", label: "关系博弈" },
  { value: "情绪递进", label: "情绪递进" },
  { value: "谜题推理", label: "谜题推理" },
  { value: "时代因果", label: "时代因果" },
  { value: "设定验证", label: "设定验证" },
  { value: "成长沉淀", label: "成长沉淀" },
  { value: "生存压力", label: "生存压力" }
];

export const WRITING_GENRE_PROMPT_GUIDES = {
  探险: {
    engine: "地图探索 / 生存压力 / 成长沉淀",
    guide:
      "题材驱动：优先让地图、生态、地方活法和风险探索推动章节；新区域必须改变路线、资源、关系或主角能力边界，不要滑向纯真相揭露、任务链或到站升级。"
  },
  都市: {
    engine: "关系博弈 / 现实资源 / 身份位移",
    guide:
      "题材驱动：优先写利益交换、身份位置、资源调度、职场/商业/家庭压力和关系博弈；冲突要落在合同、钱、人情、名声、组织流程或公开结果上。"
  },
  言情: {
    engine: "情绪递进 / 关系变化 / 误解和和解",
    guide:
      "题材驱动：优先追踪情绪递进、亲密边界、误解、试探、亏欠、和解与不可说出口的需求；每章至少改变一处关系证据，不用外部奇观替代情感推进。"
  },
  悬疑: {
    engine: "信息差 / 线索管理 / 证据链",
    guide:
      "题材驱动：优先管理信息差、线索、证词、物证、误导和证据链；新事实必须有可回溯证据，谜底不能靠临时新增规则或角色自白硬解。"
  },
  历史: {
    engine: "时代约束 / 社会结构 / 事件因果",
    guide:
      "题材驱动：优先让时代制度、阶层、礼法、交通、经济和真实社会结构限制人物选择；事件推进要符合当时的信息流、权力结构和代价。"
  },
  科幻: {
    engine: "设定验证 / 技术后果 / 社会推演",
    guide:
      "题材驱动：优先让科学设定、技术边界和社会后果推动选择；新技术必须带来限制、误用、代价或伦理压力，不能只是万能解法。"
  },
  奇幻: {
    engine: "规则代价 / 世界组织 / 神秘经验",
    guide:
      "题材驱动：优先写魔法/异能规则的代价、组织结构、信仰秩序和日常后果；奇观必须改变人物选择和世界运行，不做空泛设定展览。"
  },
  武侠: {
    engine: "江湖关系 / 门规代价 / 身体技艺",
    guide:
      "题材驱动：优先写江湖规矩、师承债务、门派脸面、身体技艺和义利冲突；武力变化要由训练、伤势、兵器、地形、前文旧训和名声代价支撑，领悟要水到渠成，不做每到一地悟一招；结局不默认天下第一或江湖之主，优先落到传承、行路、关系清账和价值选择。"
  },
  现实: {
    engine: "现实困境 / 人物选择 / 关系代价",
    guide:
      "题材驱动：优先写普通人的制度压力、生活难题、关系成本和具体选择；戏剧性来自细节累积和现实后果，不靠夸张反转硬拔高。"
  }
};
