...
## Learning: Promoted to Project Guidance
...
## Learning: Promoted to Architecture Docs
...
### Suggested Action
Add to project architecture notes: after any API changes, regenerate the client and verify generated artifacts are committed.
